...
from EuropeanEateries.queries import get_user_by_user_name, get_farmer_by_pk, get_customer_by_pk
from EuropeanEateries.utils.choices import  RestaurantName, RestaurantCity, RestaurantCuisineStyle,\
    RestaurantRanking, RestaurantRating, RestaurantPriceRange, RestaurantNumberOfReviews,\
    RestaurantReviews, RestaurantURL_TA, RestaurantID_TA, UserTypeChoices
